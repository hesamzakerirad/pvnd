    ...
    <div class="isolate bg-white py-18 sm:py-24">
        ...
        <div class="mb-6 bg-gray-100 py-32 border-t border-b border-gray-300">
            <div class="mx-auto max-w-3xl">
                <h2 class="text-2xl sm:text-3xl font-bold tracking-tight text-balance text-gray-900 mb-3">چگونه از وب‌سرویس پیوند استفاده کنیم؟</h2>
                <p class="mt-5">پیوند یک وب‌سرویس رایگان برای توسعه‌دهنده‌های عزیز ایرانی آماده کرده که به صورت نامحدود می‌تونند در توسعه
                    محصول نرم‌افزاری خود از آن استفاده کنند؛ در پایین چگونگی استفاده از این وب‌سرویس توضیح داده شده است.</p>
            </div>
        </div>
        <div class="mx-auto max-w-3xl">
